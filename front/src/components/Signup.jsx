  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (!error?.response) {
        ...
        console.log(error.response.data.constraint);
        if (error.response.data.constraint == "email") {
          setErrorMsg("cet email existe deja dans la base de donnes");
        } else if ((error.response.data.constraint = "numero_tel")) {
          ...
          <div className="bg-white space-y-6">
                ...
                <div>
                  ...
                  <div className="w-full inline-flex border">
                    ...
                    <input
                      ...
                      className=" {errors.prenom ?} w-11/12 focus:outline-none focus:text-gray-600 p-2"
                      autoComplete="off"
                      {...register("prenom", {
                        required: "ce champ est obligatoire",
                        pattern: {
                    ...
                    <input
                      ...
                      {...register("numero_tel", {
                        ...
                        pattern: {
                          value: /^[0-9]+$/,
                          message:
                            "numero de tel doit contenir aue des nombres",
                        },
                        minLength: {
                          value: 10,
            ...
            <div className="md:inline-flex w-full space-y-4 md:space-y-0 p-8 text-gray-500 items-center ">
              <div className="mx-auto flex gap-4">
                <button
                  type="submit"
                  className="text-white w-full mx-auto max-w-sm rounded text-center bg-red-600 py-2 px-8 inline-flex items-center focus:outline-none md:float-right"
                >
